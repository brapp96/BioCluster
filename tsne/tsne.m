function ydata = tsne(X, labels, no_dims, thisaxis, initial_dims, perplexity)
...
%        disp('Preprocessing data using PCA...');
    ...
    % Run t-SNE
    if initial_solution
        ydata = tsne_p(P, labels, ydata, thisaxis);
    else
        ydata = tsne_p(P, labels, no_dims, thisaxis);
    end
